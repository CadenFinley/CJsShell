...
static const Build_Config build_config = {
    ...
    .module_directories =
        (const char*[]){"src/builtin", "src/ai", "src/prompt", "src/prompt/modules",
                        "src/script_interpreter", "src/plugins", "src/utils"},
    .module_directories_count = 7,

    .isocline_c_sources =
        (const char*[]){
            "src/isocline/attr.c", "src/isocline/bbcode.c", "src/isocline/bbcode_colors.c",
            "src/isocline/common.c", "src/isocline/completers.c", "src/isocline/completions.c",
            "src/isocline/editline.c", "src/isocline/highlight.c", "src/isocline/history.c",
            "src/isocline/isocline.c", "src/isocline/stringbuf.c", "src/isocline/term.c",
