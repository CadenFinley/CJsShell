...
const std::unordered_set<std::string> SyntaxHighlighter::basic_unix_commands_ = {
    "ls","cd","pwd","echo","cat","mv","cp","rm","mkdir","rmdir","touch",
    "grep","find","chmod","chown","kill","ps","man","which","whereis"
};
...
void SyntaxHighlighter::highlight(ic_highlight_env_t* henv, const char* input, void* /*arg*/) {
