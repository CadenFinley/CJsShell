...
int ai_command(const std::vector<std::string>& args, Built_ins* built_ins) {
  ...
  if (cmd == "help") {
    std::cout
        ...
        << "  ai file                        List active files and files in "
        ...
        << "  ai file available              List files from the current "
           "directory\n"
        << "  ai file refresh                Re-read active files from disk\n"
        << "  ai file clear                  Remove all files from context\n"
        ...
        << "  ai get <key>                   Show a specific response "
           "field\n"
        << "  ai dump                        Dump all response data and the "
           "last prompt\n"
        ...
        << "  ai timeoutflag [sec]           Get or set the request timeout "
           "in seconds\n"
        ...
        << "  ai config                      Show the active configuration "
           "name\n"
        << "  ai config list                 List available configurations\n"
        << "  ai config switch <name>        Switch to another configuration\n"
        << "  ai config load <name>          Alias for 'config switch'\n"
        << "  ai config save <name>          Save over an existing "
           "configuration\n"
        << "  ai config saveas <name>        Save the current settings under "
           "a new name\n"
        << "  ai voice [voice]               Get or set the dictation voice\n"
