...
int help_command() {
    ...
    std::cout << "      ai file available            List files in the current "
                 "directory\n";
    std::cout
        << "      ai file refresh              Re-read attached files from "
           "disk\n";
    std::cout
        << "      ai file clear                Remove all attached files\n";
    std::cout << "    Configuration & storage:\n";
    std::cout
        << "      ai directory                 Show where generated files "
           "are saved\n";
    ...
    std::cout
        << "      settings <name>           Show settings for one plugin\n";
    ...
    std::cout
        << "  cd [DIR]                Change the current directory (smart "
           "cd by default)\n";
    ...
    std::cout
        << "  alias [NAME=VALUE]      Create or display command aliases\n";
    ...
    std::cout
        << "  source FILE             Execute commands from a file (alias "
           "'.')\n";
    ...
    std::cout
        << "  [[ EXPR ]]              Evaluate extended test expressions\n";
    std::cout
        << "  shift [N]               Shift positional parameters left by "
           "N\n";
    ...
    std::cout
        << "  kill [-signal] TARGET   Send a signal to a job or process\n";
    ...
    std::cout << "  hash [-r|-d] [NAME...]  Cache, display, or clear hashed "
                 "command paths\n";
    std::cout
        << "  times                   Display process times for shell and "
           "children\n";
    std::cout
        << "  umask [-S] [MODE]       Show or set the file creation mask\n";
    ...
    std::cout
        << "  prompt_test             Print available prompt variables and "
           "metrics\n\n";

    std::cout << "COMMON SYSTEM COMMANDS:\n\n";

    std::cout
        << "  clear                   Clear the terminal screen (external "
           "command)\n";
    std::cout
    ...
    std::cout
        << "    ~/.cjshrc             Aliases, functions, themes, plugins "
           "(interactive mode)\n\n";

    std::cout << "  Primary Directories:\n";
    std::cout
        << "    ~/.config/cjsh               Main data directory for CJ's "
           "Shell\n";
    ...
    std::cout << "  F1                      Show isocline key bindings and "
                 "shortcuts\n";
