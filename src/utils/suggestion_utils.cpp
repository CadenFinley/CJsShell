...
std::vector<std::string> generate_command_suggestions(
  ...
  static const std::unordered_map<std::string, std::vector<std::string>>
      essential_typos = {
          ...
          {"sl", {"ls"}},       {"ll", {"ls -l"}},    {"la", {"ls -la"}},
          {"ks", {"ls"}},       {"dir", {"ls"}},      {"cls", {"clear"}},

          {"ehco", {"echo"}},   {"exot", {"exit"}},   {"eixt", {"exit"}},
          {"quit", {"exit"}},   {"clea", {"clear"}},  {"clera", {"clear"}},
          {"whcih", {"which"}}, {"wich", {"which"}},

          {"gii", {"git"}},     {"gitt", {"git"}},    {"tig", {"git"}},

          {"grpe", {"grep"}},   {"gerp", {"grep"}},   {"sudp", {"sudo"}},
          {"sduo", {"sudo"}},   {"crul", {"curl"}},   {"wgte", {"wget"}},
          {"vmi", {"vim"}},     {"ivm", {"vim"}},     {"tarr", {"tar"}},
          {"unizp", {"unzip"}}, {"gizp", {"gzip"}},   {"gunizp", {"gunzip"}},
          {"findd", {"find"}},  {"whoa", {"whoami"}}, {"hisotry", {"history"}},
          {"basrh", {"bash"}},  {"zhs", {"zsh"}},     {"shh", {"ssh"}},
          {"rsyn", {"rsync"}},
      };
