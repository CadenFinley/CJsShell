...
HttpResponse HttpClient::system_curl_post(const std::string& url,
                                        const std::string& data,
                                        const std::map<std::string, std::string>& headers,
                                        int timeout_seconds) {
    HttpResponse response;
    ...
    std::string temp_data_file = "/tmp/cjsh_http_data_" + std::to_string(getpid());
    std::string temp_response_file = "/tmp/cjsh_http_response_" + std::to_string(getpid());
...
HttpResponse HttpClient::system_curl_head(const std::string& url,
                                        const std::map<std::string, std::string>& headers,
                                        int timeout_seconds) {
    HttpResponse response;
    response.success = false;
