...
//-------------------------------------------------------------
typedef bool(ic_completion_fun_t)(ic_env_t* env, void* funenv, const char* replacement, const char* display, const char* help,
                                  long delete_before, long delete_after);

typedef bool(ic_completion_fun_with_source_t)(ic_env_t* env, void* funenv, const char* replacement, const char* display, const char* help,
...
struct ic_completion_env_s {
    ...
    ic_completion_fun_with_source_t* complete_with_source;  // function that adds a completion with source
};
