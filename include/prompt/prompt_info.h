...
class PromptInfo {
   ...
   public:
    ...
    std::string get_current_file_name() {
        return basic_info.get_current_file_name();
    }
    std::string get_current_file_path() {
        return basic_info.get_current_file_path();
    }
    std::string get_username() {
        return basic_info.get_username();
    }
    ...
    std::pair<int, int> get_terminal_dimensions() {
        return environment_info.get_terminal_dimensions();
    }
    std::string get_active_language_version(const std::string& language) {
        return environment_info.get_active_language_version(language);
    }
    bool is_in_virtual_environment(std::string& env_name) {
        return environment_info.is_in_virtual_environment(env_name);
    }
    int get_background_jobs_count() {
        return environment_info.get_background_jobs_count();
    }
    std::string get_shell() {
        return environment_info.get_shell();
    }
    ...
    bool is_vpn_active() {
        return network_info.is_vpn_active();
    }
    ...
    std::string get_current_date() {
        return time_info.get_current_date();
    }
    int get_current_day() {
        return time_info.get_current_day();
    }
    int get_current_month() {
        return time_info.get_current_month();
    }
    int get_current_year() {
        return time_info.get_current_year();
    }
    std::string get_current_day_name() {
        return time_info.get_current_day_name();
    }
