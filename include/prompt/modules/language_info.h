...
class LanguageInfo {
   private:
    ...
    std::vector<std::string> cpp_extensions = {".c",   ".cpp", ".cxx", ".cc",
                                               ".c++", ".h",   ".hpp", ".hxx",
                                               ".hh",  ".h++"};
    ...
    std::vector<std::string> ruby_extensions = {".rb", ".rbx", ".rbi",
                                                ".gemspec", ".rake"};
    ...
    std::vector<std::string> scala_files = {"build.sbt", "build.sc",
                                            ".scalaenv", ".sbtrc", ".sbtopts"};
