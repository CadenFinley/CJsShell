...
class LanguageInfo {
   private:
    ...
    std::vector<std::string> nodejs_files = {"package.json", ".node-version", ".nvmrc"};
    std::vector<std::string> nodejs_extensions = {".js", ".mjs", ".cjs", ".ts", ".mts", ".cts"};
    ...
    std::vector<std::string> ruby_extensions = {".rb", ".rbx", ".rbi", ".gemspec", ".rake"};
    std::vector<std::string> ruby_folders = {".bundle"};

    std::vector<std::string> kotlin_files = {"build.gradle.kts", "settings.gradle.kts"};
